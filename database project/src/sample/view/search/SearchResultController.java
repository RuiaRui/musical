...
public class SearchResultController extends Controller {
    ...
    @FXML
    private TableView<Musical> resultTable;
    @FXML
    ...
    public void initializeTable(String type, String search){
        ...
        setMusicalData(type,search);
        resultTable.setItems(getMusicalData());
    }
    ...
    public void setMusicalData(String type, String search) {
        try {
            musicalData.clear();
            JDBC jdbc = new JDBC();
            Connection connection = jdbc.getConnection();
            Statement statement = connection.createStatement();
            String sql ="SELECT * FROM musicals WHERE "+type+" like '%"+search+"%'";
    ...
    public int getSelectMusicalId(){
        ...
        int selectIndex = resultTable.getSelectionModel().getSelectedIndex();
        if(selectIndex>=0) {
            selectMusicalId = resultTable.getItems().get(selectIndex).getMusicalId();
        }
